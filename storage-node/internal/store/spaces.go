...
func builtinSpaceProfiles() []spaceProfile {
	return []spaceProfile{
		...
		{Name: "slips", Visibility: "shared", Encryption: "none", Retention: "none", ImportGrant: "allowed", Builtin: true},
		{Name: "instructions", Visibility: "shared", Encryption: "none", Retention: "none", ImportGrant: "allowed", Builtin: true},
