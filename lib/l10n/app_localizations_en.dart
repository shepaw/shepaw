...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get privacy_content =>
      'Privacy Policy\n\nLast updated: 2026-07-16\n\nShePaw / Paw (\"we\", \"our\", or \"us\") is committed to protecting your privacy. The app is local-first: we do not operate a cloud backend that collects your personal data, and we do not upload your data unless you configure a destination. App data stays on your device by default and remains under your control.\n\n1. Data Storage\n\nShePaw does not require a cloud account or our own user-data servers. Data created while you use the app, including:\n- Local identity and pairing information\n- Agent / model configuration\n- Chat messages and conversation history\n\nis stored on your device by default. We cannot and will not access this local data.\n\n2. Data Security (aligned with the implementation)\n\n- Sensitive credentials such as API keys and Noise identity private keys: the master key is preferentially kept in platform secure storage (Keychain / Keystore)\n- Chat history and general app data: stored locally (e.g. SQLite) without full-database encryption at rest by default; device backups, jailbreak/root, or filesystem access may expose this content\n- Optional app lock (password / biometrics) can restrict opening the app\n- When talking to remote agents / LLMs, use endpoints you trust; production paths require valid TLS certificates\n\n3. Third-Party Services\n\nWhen you configure remote AI agents, model providers, or a local Hub / gateway, messages and attachments travel between your device and the endpoints you configure. We are not responsible for third-party data practices. Peer / group features sync data according to your pairing and authorization relationships.\n\n4. Your Rights\n\nBecause core data stays on-device by default, you can at any time:\n- View and manage your data in the app\n- Delete local data by clearing app data or uninstalling\n- Export data using in-app export features when available\n\n5. Changes to This Policy\n\nWe may update this Privacy Policy from time to time and will reflect changes by updating the \"Last updated\" date.';
