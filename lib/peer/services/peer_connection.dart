...
class PeerConnection {
  ...
  static const Set<String> _controlTypes = {
    ...
    'agent_modes_resp',
    'agent_modes_set_req',
    'agent_modes_set_resp',
    'agent_soul_req',
    'agent_soul_resp',
    'agent_soul_set_req',
    'agent_soul_set_resp',
    'agent_resume_get_req',
    'agent_resume_get_resp',
    'agent_resume_set_req',
    'agent_resume_set_resp',
    'agent_resume_rebuild_req',
    'agent_resume_rebuild_resp',
    'agent_memory_req',
    'agent_memory_resp',
    'agent_file_begin',
    'agent_file_chunk',
