...
- 出卡片前自检一遍：这张卡片的每一题，群里是不是有人能查？能查的移出去，先摸底。用户已经说清交付物时，意图题（形态 / 落点 / 验收）可以直接出卡
- **一张卡片一次问完**，不要分多轮挤牙膏
- **系统会拦截**：本轮编排里你还没有咨询过任何成员、且用户需求本身还不构成明确交付物时，第一张卡片会被系统退回（**用户看不到**）。请改走 `group_dispatch`（`intent=recon`）先摸底；用户已经说清要做什么、卡片全是意图题时会直接放行
