...
```''',
  ...
  test('buildMemberTurnContent injects formal task plan between global and local task',
      () {
    final content = GroupDispatchParser.buildMemberTurnContent(
      memberBrief: '实现登录',
  ...
  test('buildMemberTurnContent appends peer results note (PR-7)', () {
    final content = GroupDispatchParser.buildMemberTurnContent(
      memberBrief: '写测试',
  ...
  test('buildTaskPlanNote truncates long plan bodies', () {
